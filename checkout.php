                ...
                <div class="col-md-6 col-lg-7">                
                    <div class="row g-3">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="fullname" class="form-control" placeholder="" value="<?php echo htmlspecialchars($_SESSION['name']); echo " "; echo htmlspecialchars($_SESSION['surname']); ?>">                            
                        </div>
    
                        <div class="col-sm-6">
                            <label class="form-label">Tel.</label>
                            <input type="text" name="tel" pattern="^0[689]\d{8}$" class="form-control" placeholder="" value="<?php echo htmlspecialchars($_SESSION['tel']); ?>">                            
                        </div>
    
                        <div class="col-sm-6">
                            <label class="form-label">Email</label>
                            <input type="email" name="email" class="form-control" placeholder="" value="<?php echo htmlspecialchars($_SESSION['email']); ?>">                            
                        </div>

                        <div class="form-group">
                            <label for="address">address</label>
                            <textarea class="form-control" name="address" id="address" rows="3"><?php echo htmlspecialchars($_SESSION['address']); ?></textarea>
                        </div>
                    </div>
                    <hr class="my-4">
                    <div class="text-end">
                        <a href="<?php echo $base_url; ?>/index.php" class="btn btn-secondary btn-lg" role="button">Back to product</a>
